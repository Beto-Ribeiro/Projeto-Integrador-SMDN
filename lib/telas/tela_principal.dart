...
class _TelaPrincipalState extends State<TelaPrincipal> {
  ...
  int _currentIndex = Supabase.instance.client.auth.currentUser == null ? 5 : 0;
  ...
  Widget build(BuildContext context) {
    final List<Widget> _telas = [
      ...
      ), // O MAPA É A SEGUNDA PÁGINA (Índice 1)
    ...
    return Scaffold(
      extendBody:
          true, // Garante que o mapa passe por trás da barra transparente
