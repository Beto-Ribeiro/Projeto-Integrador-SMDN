                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text("Precisa de ajuda de", style: TextStyle(fontSize: 34, fontWeight: FontWeight.bold,color: Color.fromRGBO(9, 22, 46, 1) ),),
                      ),
                      Container(
                        width: double.infinity,
                        alignment: Alignment.center,
                        child: Text("emergência?", style: TextStyle(fontSize: 34,fontWeight: FontWeight.bold,color: Color.fromRGBO(9, 22, 46, 1) ),),
                      ),
                      Container(
                        width: double.infinity,
                        alignment: Alignment.center,
                        child: Text("Pressione o botão abaixo para acioná-la", style: TextStyle(fontSize: 18,color: Color.fromRGBO(68, 118, 155, 1) ),),
                      ),
                      SizedBox(
                        height: 20,
                      ),
