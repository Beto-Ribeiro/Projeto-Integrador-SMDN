...
class _Relatos_telaState extends State<Relatos_tela> {
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      LatLng posicaoAtual = LatLng(_locationData.latitude!, _locationData.longitude!);
      ...
      if (mapController != null) {
        mapController!.animateCamera(CameraUpdate.newLatLngZoom(posicaoAtual, 16));
      }
    } catch (e) {
  ...
  Future<void> enviarRelato() async {
    try {
      ...
      if (usuarioLogado == null) {
        _mostrarSnackBar('Erro: Você precisa estar logado para enviar um relato.', Colors.red);
        return;
      }
      ...
      if (tipoSelecionado == null ||
        ...
        _mostrarSnackBar('Preencha todos os campos e selecione a localização no mapa.', Colors.orange);
        return;
      }
      ...
      final String pontoGeografico = 'POINT(${localizacaoSelecionada!.longitude} ${localizacaoSelecionada!.latitude})';
      ...
      if (respostaRelato.isEmpty) {
        throw Exception("O relato foi salvo, mas não retornou os dados. Verifique o RLS.");
      }
      ...
      await supabase.storage.from('Fotos_Storage').uploadBinary(path, imagemBytes!);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: imagemBytes == null
                            ? const Center(child: Text('Insira uma imagem', style: TextStyle(fontSize: 16)))
                            : ClipRRect(
                    ...
                    const Text('Escolha o tipo de desastre:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 15),

                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
                        _iconDesastre(0, 'gfx/png/icons/tipo_inundacao.png', 'Enchente'),
                        _iconDesastre(1, 'gfx/png/icons/tipo_tornado.png', 'Ciclone'),
                        _iconDesastre(2, 'gfx/png/icons/tipo_deslizamento.png', 'Deslizamento'),
                        _iconDesastre(3, 'gfx/png/icons/tipo_tempestade.png', 'Chuva Forte'),
                      ],
                    ),
                    const SizedBox(height: 25),

                    const Text('Classifique a periculosidade/risco:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                    const Text('(considere 1 menor periculosidade 5 maior periculosidade)', style: TextStyle(fontSize: 12, color: Colors.black54)),
                    const SizedBox(height: 15),
                    ...
                    const Text('Escolha o local do desastre:', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 15),
                      ...
                      child: ClipRRect(
                        ...
                        child: _isLoadingMap
                          ...
                          initialCameraPosition: CameraPosition(
                            target: localizacaoSelecionada ?? const LatLng(-23.5505, -46.6333),
                            zoom: 15,
                          ),
                    ...
                    Row(
                      children: [
                        ...
                        const Text('Utilizar minha localização atual.', style: TextStyle(fontSize: 14)),
                      ],
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text('Reportar', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                      ),
                    ),
        ...
        children: [
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              color: selecionado ? const Color(0xFF8AB3FF) : const Color(0xFF09162E),
              border: Border.all(
            ...
            child: Image.asset(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Icon(
                  ...
                  color: selecionado ? const Color(0xFF09162E) : const Color(0xFF8AB3FF),
                  size: 32,
                );
              },
            ),
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(texto, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: cor)),
        ],
      ),
    );
  }
